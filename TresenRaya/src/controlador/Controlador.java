...
public class Controlador implements ActionListener 
{
	...
	private int turno = 1;
	private int tipoDeVentanaActual; 
	/**
	 * Metodo Contructor
	 * */	
	public Controlador() 
     ...
     * se inserta una ficha el la VentanaJuego o cuando se realiza alguna operacion 
     * dentro de esta
     * */	
				...
				if( partida.getGanador()==0)
				{
					...
					if(boton == ventanaJuego.b1)
					{
						...
						if(estado==true)
						{
							...
							if(ventanaOpciones.getFigura(turno)=="Ficha1")
							{
								ventanaJuego.b1.setIcon(new ImageIcon("/imagenes/Bart.png"));
							}							
							cambiarturno();
						}
						else
